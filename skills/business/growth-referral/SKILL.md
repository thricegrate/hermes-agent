...
**For vendor-side affiliate program operations**: See [references/affiliate-program-operations.md](references/affiliate-program-operations.md). Covers 3 affiliate relationship types (Unattached/Related/Involved), 5 compensation models, commission structures (tiered, super affiliate, temporary launch increases), EPC principle, recruitment process (students-first to marketplaces), promotional material kit, T&C checklist (12 items), FTC disclosure requirements, and SEO coordination rules.
...
## Kennedy Referral Checkpoint

Before launching or optimizing a referral program, run these checks (see `references/kennedy-referral-system.md`):

1. **Specificity test**: Can you describe your ideal referral in one sentence with 3+ qualifiers?
2. **Ease test**: Can someone share you in under 10 seconds from their phone?
3. **Recognition system**: Do you publicly thank referrers? (Start here if nothing else.)
4. **Endorsed mailing pipeline**: Do you have 3+ potential partners who could send to their list on your behalf?
5. **Forward-worthy asset**: Do you have one piece of content specifically designed to be shared?
6. **Commitment loop**: Are referrers becoming better customers? (Track retention by referral status.)
...
- **marketing-foundations**: For understanding referral motivation
