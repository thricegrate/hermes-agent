...
70+ mental models for making better marketing decisions, understanding buyer behavior, and ethically influencing customer actions.
...
Behavior = Motivation x Ability x Prompt. All three must be present for action.
