...
This takes less than 30 seconds., [Product] Team
```
...
Need help? Just reply to this email., [Product] Team
```
...
Questions? Reply here and we'll help., [Product] Team
```
...
updating your payment method., [Product] Team
```
...
will be paused automatically., [Product] Team
```
