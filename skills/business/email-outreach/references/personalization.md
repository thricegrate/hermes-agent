...
## CTA Personalization (202% More Conversions)

Personalized CTAs convert 202% better than generic ones (HubSpot). In cold email, the CTA is usually a reply request, but personalize it to their situation:

- Generic: "Would you be open to a quick chat?"
- Personalized: "Would it be worth 10 minutes to see how [similar company] solved [their specific problem]?"
- Trigger-based: "Since you're hiring [role], want to see how [company] onboarded 5 SDRs in 2 weeks?"

The CTA should feel like a natural continuation of the personalized opening, not a pivot to a pitch.
